'''Script for troubleshooting and looking at an individual record from tt database.
Edit the LOOK_FOR constant to search for a particular device_urn.
Later, this script could use a regexp to filter specific devices.
'''
